...
class Version20170707130706 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE users__developer (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE users__developer ADD CONSTRAINT FK_FF0C8513BF396750 FOREIGN KEY (id) REFERENCES users__user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users__developer DROP FOREIGN KEY FK_FF0C8513BF396750');
        ...
        $this->addSql('DROP TABLE users__developer');
