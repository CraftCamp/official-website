...
return [
    [
        'id' => 1,
        'name' => 'Plateforme CraftCamp',
		'description' => 'Plateforme de l\'association',
        'slug' => 'plateforme-craftcamp',
        'product_owner_id' => 1,
        'created_at' => '2016-07-01'
    ],
    [
        'id' => 2,
        'name' => 'Doctrine Backup Bundle',
		'description' => 'Bundle Symfony de sauvegarde et restauration de base de données',
    ...
    [
        'id' => 5,
        'name' => 'Bloodline',
        'description' => 'Communauté de donneurs de sang connectée aux besoins des professionnels de santé',
        'slug' => 'bloodline',
        'product_owner_id' => 1,
