 ...
 */
final class Version20180604074628 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project__details ADD CONSTRAINT FK_3B20612C166D1F9C FOREIGN KEY (project_id) REFERENCES developtech_agility__projects (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE project__details');
    }
}
